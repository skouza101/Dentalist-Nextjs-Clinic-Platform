                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-9">
                                ...
                                <blockquote className='single-post-quote'>{t("“ Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor ”")}</blockquote>
                        ...
                        <div className="col-lg-3">
                            <div className="blog-sidebar">
                                <div className="sidebar-subscribe mb-5">
                                    <h3 className="sidebar-heading">{t("Get Latest Updates")}</h3>
                                    <form>
                                        <div className="form-group">
                                            <input type="email" className='form-control' placeholder={t("Subscribe to email")}/>
                                            <input className='btn btn-primary mt-1 w-100' type="button" value={t("Subscribe")} />
                                        </div>
                                    </form>
                                </div>

                                <div className="sidebar-category mb-3">
                                    <h3 className="sidebar-heading">{t("Categories")}</h3>
                                    <ul>
                                        <li><Link to="/">{t("Technology")}</Link></li>
                                        <li><Link to="/">{t("Root Canal")}</Link></li>
                                        <li><Link to="/">{t("Teeth")}</Link></li>
                                        <li><Link to="/">{t("Whitening")}</Link></li>
                                        <li><Link to="/">{t("Dentures")}</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
